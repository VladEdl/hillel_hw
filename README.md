...
Створіть змінну totalPrice, де порахуйте суму:

cart[0].price * cart[0].qty + cart[1].price * cart[1].qty

Додайте третій товар у новий масив updatedCart (тільки вручну), наприклад:

{ title: "Pen", price: 20, qty: 5 }

Створіть змінну itemNames, де у вигляді рядка: "Book, Laptop, Pen" 

(самостійно об’єднайте: cart[0].title + ", " + cart[1].title + ...)